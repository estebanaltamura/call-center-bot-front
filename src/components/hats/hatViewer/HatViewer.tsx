...
//   const [currentKnowledgeName, setCurrentKnowledgeName] = useState<string | null>(null);
//   const [currentRulesName, setCurrentRulesName] = useState<string | null>(null);

//   const getHat = async () => {
//     const res = await SERVICES.CMS.get(Entities.hats, 'id', '==', hatId);

//     if (!res || [0]) return;

//     const hat = res[0];

//     setCurrentBusinessName(hat.business);
//     setCurrentAssistantName(hat.assistant);
//     setCurrentKnowledgeName(hat.knowledge);
//     setCurrentRulesName(hat.rule);
//   };
